...
function WorldTeleport.TryGetTransferMapInfo(srcID, dstID)
  ...
  if transferInfo2 then
    ...
    transferCost = transferCost + transferCost2 + MapTeleportUtil.EstimateNpcTransCost
  end
  ...
  if transferInfo1 then
    ...
    transferCost = transferCost + transferCost1 + MapTeleportUtil.EstimateNpcTransCost
  end
