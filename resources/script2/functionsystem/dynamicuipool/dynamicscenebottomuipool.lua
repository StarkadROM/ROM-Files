...
function DynamicSceneBottomUIPool:create(_id, _parent, _creature)
  if #self.m_cacheList == 0 then
    ...
    Game.CreatureUIManager:AsyncCreateUIAsset(_id, resId, _parent, self.loadNameFactionFinish, _creature, nil, SceneBottomNameFactionCell.OpitimizedMode)
  else
...
function DynamicSceneBottomUIPool.loadNameFactionFinish(obj, creature)
  if obj then
    local data = {}
    data[1] = obj
    data[2] = creature
