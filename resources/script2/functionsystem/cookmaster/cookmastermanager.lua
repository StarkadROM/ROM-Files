    ...
    if FoodMaterialSeperate[i].count and 0 < FoodMaterialSeperate[i].count then
      ...
      for j = 1, count do
        ...
        for k = 1, #materials do
          ...
          if not (#self.randomMaterialList > 12) then
...
function CookMasterManager:GetResult()
  ...
  if playerRecipe and #playerRecipe > 0 then
  ...
  if enemyRecipe and #enemyRecipe > 0 then
  ...
  if self.inMode7 then
    ...
    GameFacade.Instance:sendNotification(UIEvent.JumpPanel, {
      ...
      viewdata = {
        ...
        inMode7Context = {
          isWin = playerRecipe and #playerRecipe > 0 and playerRecipe[1].recipeId == self.inMode7Data.params.recipe_id1
        }
      }
    })
    return
