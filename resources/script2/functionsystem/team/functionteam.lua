...
function FunctionTeam:OnClickMatch(goal, only_myserver, entranceid)
  if Game.Myself:IsDead() then
    MsgManager.ShowMsgByIDTable(2500)
    return false
  end
  ...
  local matchFunc = function()
    ServiceMatchCCmdProxy.Instance:CallJoinRoomCCmd(sData.Type, sData.RaidConfigID, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, only_myserver, entranceid)
  end
