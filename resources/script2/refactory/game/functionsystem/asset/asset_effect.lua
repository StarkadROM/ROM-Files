...
function Asset_Effect.PlayOneShotAtXYZ(path, x, y, z, callback, callbackArg, scale, lodLevel, priority, effectType)
  tempArgs[1] = path
...
function Asset_Effect.PlayOneShotAt(path, p, callback, callbackArg, scale, lodLevel, priority, effectType)
  return Asset_Effect.PlayOneShotAtXYZ(path, p[1], p[2], p[3], callback, callbackArg, scale, lodLevel, priority, effectType)
end
function Asset_Effect.PlayOneShotOn(path, parent, callback, callbackArg, scale, lodLevel, priority, effectType)
  tempArgs[1] = path
...
function Asset_Effect.PlayAtXYZ(path, x, y, z, callback, callbackArg, scale, lodLevel, priority, effectType)
  tempArgs[1] = path
  LuaVector3.Better_Set(tempArgs[2], x, y, z)
  LuaVector3.Better_Set(tempArgs[3], 0, 0, 0)
  LuaVector3.Better_Set(tempArgs[4], scale or 1, scale or 1, scale or 1)
...
function Asset_Effect.PlayAt(path, p, callback, callbackArg, scale, lodLevel, priority, effectType)
  return Asset_Effect.PlayAtXYZ(path, p[1], p[2], p[3], callback, callbackArg, scale, lodLevel, priority, effectType)
end
function Asset_Effect.PlayOn(path, parent, callback, callbackArg, scale, lodLevel, priority, effectType)
  tempArgs[1] = path
  LuaVector3.Better_Set(tempArgs[2], 0, 0, 0)
  LuaVector3.Better_Set(tempArgs[3], 0, 0, 0)
  LuaVector3.Better_Set(tempArgs[4], scale or 1, scale or 1, scale or 1)
  ...
  if self.args[6] then
    ...
    if mesh then
      ...
      if meshrender and meshrender.materials then
        local tmpPos = Vector4(0, speed, 0, 0)
