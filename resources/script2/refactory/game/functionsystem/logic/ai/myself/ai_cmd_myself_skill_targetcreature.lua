...
function SkillCMD_Run:Start(time, deltaTime, creature, targetCreature)
  return AI_CMD_Myself_Skill_Run.Start(self, time, deltaTime, creature, targetCreature, targetCreature:GetPosition(), self.args[7], self.args[9], self.args[10], self.args[11])
end
return SkillCMD
