...
function IdleAI_FollowLeader:Prepare(idleElapsed, time, deltaTime, creature)
  ...
  self:_SwitchLeader(self.requestLeaderID, self.requestIgnoreNotifyServer, self.requestDoubleAction)
...
function IdleAI_FollowLeader:TryCallGoMap(leader, time)
  ...
  local currentRaidID, leaderRaidID = leader.raid or Game.MapManager:GetRaidID(), 0
...
function IdleAI_FollowLeader:_SwitchLeader(newLeaderID, ignoreNotifyServer, forDoubleAction)
