...
function FactoryAICMD.GetPlayActionCmd(name, normalizedTime, loop, fakeDead, forceDuration, freezeAtEnd, actionSpeed)
...
function FactoryAICMD.GetClientAvoidTargetCmd(target, duration, range, moveSpeed)
...
function FactoryAICMD.Me_GetSkillCmd(skillID, targetCreature, targetPosition, ignoreNavMesh, forceTargetCreature, allowResearch, noLimit, ignoreCast, isAttackSkill, autoInterrupt, concurrent, ignoreHit, isTriggerSkill)
...
function FactoryAICMD.Me_GetPlayActionCmd(name, normalizedTime, loop, fakeDead, forceDuration, freezeAtEnd, actionSpeed)
...
function FactoryAICMD.Me_GetPlayHolyActionCmd(name, normalizedTime, loop, fakeDead, forceDuration, freezeAtEnd)
