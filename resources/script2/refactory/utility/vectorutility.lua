...
function VectorUtility.AlmostEqual_2(v1, v2)
  ...
  return diff1 >= -0.01 and diff1 <= 0.01 and diff2 >= -0.01 and diff2 <= 0.01
end
function VectorUtility.AlmostEqual_3(v1, v2)
  local diff1 = v1[1] - v2[1]
  local diff2 = v1[2] - v2[2]
  local diff3 = v1[3] - v2[3]
  return diff1 >= -0.01 and diff1 <= 0.01 and diff2 >= -0.01 and diff2 <= 0.01 and diff3 >= -0.01 and diff3 <= 0.01
end
