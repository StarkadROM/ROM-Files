...
QUESTPARAM_QUESTPARAM_MANUAL_FUNCTION_ENUM = protobuf.EnumValueDescriptor()
...
QUESTNAME_TYPE_FIELD = protobuf.FieldDescriptor()
...
QUESTMANUAL_PLOTVOICE_FIELD = protobuf.FieldDescriptor()
...
QUESTMANUALFUNCTION = protobuf.Descriptor()
QUESTMANUALFUNCTION_ID_FIELD = protobuf.FieldDescriptor()
QUESTMANUALFUNCTION_FINISHID_FIELD = protobuf.FieldDescriptor()
QUESTMANUALFUNCTION_NAME_FIELD = protobuf.FieldDescriptor()
QUESTMANUALFUNCTION_MAPID_FIELD = protobuf.FieldDescriptor()
QUESTMANUALFUNCTION_DATA_FIELD = protobuf.FieldDescriptor()
MANUALFUNCTIONQUESTCMD = protobuf.Descriptor()
MANUALFUNCTIONQUESTCMD_CMD_FIELD = protobuf.FieldDescriptor()
MANUALFUNCTIONQUESTCMD_PARAM_FIELD = protobuf.FieldDescriptor()
MANUALFUNCTIONQUESTCMD_ITEMS_FIELD = protobuf.FieldDescriptor()
...
QUESTPARAM_QUESTPARAM_MANUAL_FUNCTION_ENUM.name = "QUESTPARAM_MANUAL_FUNCTION"
QUESTPARAM_QUESTPARAM_MANUAL_FUNCTION_ENUM.index = 21
QUESTPARAM_QUESTPARAM_MANUAL_FUNCTION_ENUM.number = 23
QUESTPARAM_QUESTPARAM_QUERY_QUESTLIST_ENUM.name = "QUESTPARAM_QUERY_QUESTLIST"
QUESTPARAM_QUESTPARAM_QUERY_QUESTLIST_ENUM.index = 22
QUESTPARAM_QUESTPARAM_QUERY_QUESTLIST_ENUM.number = 24
QUESTPARAM_QUESTPARAM_MAPSTEP_SYNC_ENUM.name = "QUESTPARAM_MAPSTEP_SYNC"
QUESTPARAM_QUESTPARAM_MAPSTEP_SYNC_ENUM.index = 23
...
QUESTPARAM_QUESTPARAM_MAPSTEP_UPDATE_ENUM.index = 24
...
QUESTPARAM_QUESTPARAM_EVIDENCE_QUERY_ENUM.index = 31
...
QUESTPARAM_QUESTPARAM_UNLOCK_EVIDENCE_MESSAGE_ENUM.index = 32
...
QUESTPARAM_QUESTPARAM_QUERY_CHARACTER_INFO_ENUM.index = 33
...
QUESTPARAM_QUESTPARAM_EVIDENCE_HINT_ENUM.index = 34
...
QUESTPARAM_QUESTPARAM_NEW_EVIDENCE_UPDATE_ENUM.index = 37
...
QUESTPARAM_QUESTPARAM_LEAVE_VISIT_NPC_ENUM.index = 38
...
QUESTPARAM_QUESTPARAM_COMPLETE_AVAILABLE_QUERY_ENUM.index = 39
...
QUESTPARAM_QUESTPARAM_QUESTHERO_QUERY_ENUM.index = 45
...
QUESTPARAM.values = {
  ...
  QUESTPARAM_QUESTPARAM_MANUAL_FUNCTION_ENUM,
...
EQUESTTYPE_EQUESTTYPE_MAX_ENUM.index = 71
EQUESTTYPE_EQUESTTYPE_MAX_ENUM.number = 71
...
EQUESTSTEP_EQUESTSTEP_MAX_ENUM.index = 142
EQUESTSTEP_EQUESTSTEP_MAX_ENUM.number = 147
...
QUESTPCONFIG_STARTTIME_FIELD.index = 15
...
QUESTPCONFIG_ENDTIME_FIELD.index = 16
...
QUESTPCONFIG_ICON_FIELD.index = 17
...
QUESTPCONFIG_COLOR_FIELD.index = 18
...
QUESTPCONFIG_QUESTNAME_FIELD.index = 19
...
QUESTPCONFIG_NAME_FIELD.index = 20
...
QUESTPCONFIG_TYPE_FIELD.index = 21
...
QUESTPCONFIG_CONTENT_FIELD.index = 22
...
QUESTPCONFIG_TRACEINFO_FIELD.index = 23
...
QUESTPCONFIG_PREFIXION_FIELD.index = 24
...
QUESTPCONFIG_VERSION_FIELD.index = 25
...
QUESTPCONFIG_PARAMS_FIELD.index = 26
...
QUESTPCONFIG_ALLREWARDID_FIELD.index = 27
...
QUESTPCONFIG_PREQUEST_FIELD.index = 28
...
QUESTPCONFIG_MUSTPREQUEST_FIELD.index = 29
...
QUESTPCONFIG_PREMENU_FIELD.index = 30
...
QUESTPCONFIG_MUSTPREMENU_FIELD.index = 31
...
QUESTPCONFIG_HEADICON_FIELD.index = 32
...
QUESTPCONFIG_HIDE_FIELD.index = 33
...
QUESTPCONFIG_CREATETIME_FIELD.index = 34
...
QUESTNAME_TYPE_FIELD.name = "type"
QUESTNAME_TYPE_FIELD.full_name = ".Cmd.QuestName.type"
QUESTNAME_TYPE_FIELD.number = 3
QUESTNAME_TYPE_FIELD.index = 2
QUESTNAME_TYPE_FIELD.label = 1
QUESTNAME_TYPE_FIELD.has_default_value = true
QUESTNAME_TYPE_FIELD.default_value = 0
QUESTNAME_TYPE_FIELD.enum_type = EQUESTLIST
QUESTNAME_TYPE_FIELD.type = 14
QUESTNAME_TYPE_FIELD.cpp_type = 8
...
QUESTMANUALMAIN_MAINSTORYID_FIELD.label = 3
QUESTMANUALMAIN_MAINSTORYID_FIELD.has_default_value = false
QUESTMANUALMAIN_MAINSTORYID_FIELD.default_value = {}
...
QUESTMANUAL_PLOTVOICE_FIELD.name = "plotvoice"
QUESTMANUAL_PLOTVOICE_FIELD.full_name = ".Cmd.QuestManual.plotvoice"
QUESTMANUAL_PLOTVOICE_FIELD.number = 6
QUESTMANUAL_PLOTVOICE_FIELD.index = 5
QUESTMANUAL_PLOTVOICE_FIELD.label = 3
QUESTMANUAL_PLOTVOICE_FIELD.has_default_value = false
QUESTMANUAL_PLOTVOICE_FIELD.default_value = {}
QUESTMANUAL_PLOTVOICE_FIELD.type = 13
QUESTMANUAL_PLOTVOICE_FIELD.cpp_type = 3
...
QUESTMANUALFUNCTION_ID_FIELD.name = "id"
QUESTMANUALFUNCTION_ID_FIELD.full_name = ".Cmd.QuestManualFunction.id"
QUESTMANUALFUNCTION_ID_FIELD.number = 1
QUESTMANUALFUNCTION_ID_FIELD.index = 0
QUESTMANUALFUNCTION_ID_FIELD.label = 1
QUESTMANUALFUNCTION_ID_FIELD.has_default_value = true
QUESTMANUALFUNCTION_ID_FIELD.default_value = 0
QUESTMANUALFUNCTION_ID_FIELD.type = 13
QUESTMANUALFUNCTION_ID_FIELD.cpp_type = 3
QUESTMANUALFUNCTION_FINISHID_FIELD.name = "finishid"
QUESTMANUALFUNCTION_FINISHID_FIELD.full_name = ".Cmd.QuestManualFunction.finishid"
QUESTMANUALFUNCTION_FINISHID_FIELD.number = 2
QUESTMANUALFUNCTION_FINISHID_FIELD.index = 1
QUESTMANUALFUNCTION_FINISHID_FIELD.label = 3
QUESTMANUALFUNCTION_FINISHID_FIELD.has_default_value = false
QUESTMANUALFUNCTION_FINISHID_FIELD.default_value = {}
QUESTMANUALFUNCTION_FINISHID_FIELD.type = 13
QUESTMANUALFUNCTION_FINISHID_FIELD.cpp_type = 3
QUESTMANUALFUNCTION_NAME_FIELD.name = "name"
QUESTMANUALFUNCTION_NAME_FIELD.full_name = ".Cmd.QuestManualFunction.name"
QUESTMANUALFUNCTION_NAME_FIELD.number = 3
QUESTMANUALFUNCTION_NAME_FIELD.index = 2
QUESTMANUALFUNCTION_NAME_FIELD.label = 1
QUESTMANUALFUNCTION_NAME_FIELD.has_default_value = false
QUESTMANUALFUNCTION_NAME_FIELD.default_value = ""
QUESTMANUALFUNCTION_NAME_FIELD.type = 9
QUESTMANUALFUNCTION_NAME_FIELD.cpp_type = 9
QUESTMANUALFUNCTION_MAPID_FIELD.name = "mapid"
QUESTMANUALFUNCTION_MAPID_FIELD.full_name = ".Cmd.QuestManualFunction.mapid"
QUESTMANUALFUNCTION_MAPID_FIELD.number = 4
QUESTMANUALFUNCTION_MAPID_FIELD.index = 3
QUESTMANUALFUNCTION_MAPID_FIELD.label = 1
QUESTMANUALFUNCTION_MAPID_FIELD.has_default_value = true
QUESTMANUALFUNCTION_MAPID_FIELD.default_value = 0
QUESTMANUALFUNCTION_MAPID_FIELD.type = 13
QUESTMANUALFUNCTION_MAPID_FIELD.cpp_type = 3
QUESTMANUALFUNCTION_DATA_FIELD.name = "data"
QUESTMANUALFUNCTION_DATA_FIELD.full_name = ".Cmd.QuestManualFunction.data"
QUESTMANUALFUNCTION_DATA_FIELD.number = 5
QUESTMANUALFUNCTION_DATA_FIELD.index = 4
QUESTMANUALFUNCTION_DATA_FIELD.label = 1
QUESTMANUALFUNCTION_DATA_FIELD.has_default_value = false
QUESTMANUALFUNCTION_DATA_FIELD.default_value = nil
QUESTMANUALFUNCTION_DATA_FIELD.message_type = QUESTDATA
QUESTMANUALFUNCTION_DATA_FIELD.type = 11
QUESTMANUALFUNCTION_DATA_FIELD.cpp_type = 10
QUESTMANUALFUNCTION.name = "QuestManualFunction"
QUESTMANUALFUNCTION.full_name = ".Cmd.QuestManualFunction"
QUESTMANUALFUNCTION.nested_types = {}
QUESTMANUALFUNCTION.enum_types = {}
QUESTMANUALFUNCTION.fields = {
  QUESTMANUALFUNCTION_ID_FIELD,
  QUESTMANUALFUNCTION_FINISHID_FIELD,
  QUESTMANUALFUNCTION_NAME_FIELD,
  QUESTMANUALFUNCTION_MAPID_FIELD,
  QUESTMANUALFUNCTION_DATA_FIELD
}
QUESTMANUALFUNCTION.is_extendable = false
QUESTMANUALFUNCTION.extensions = {}
MANUALFUNCTIONQUESTCMD_CMD_FIELD.name = "cmd"
MANUALFUNCTIONQUESTCMD_CMD_FIELD.full_name = ".Cmd.ManualFunctionQuestCmd.cmd"
MANUALFUNCTIONQUESTCMD_CMD_FIELD.number = 1
MANUALFUNCTIONQUESTCMD_CMD_FIELD.index = 0
MANUALFUNCTIONQUESTCMD_CMD_FIELD.label = 1
MANUALFUNCTIONQUESTCMD_CMD_FIELD.has_default_value = true
MANUALFUNCTIONQUESTCMD_CMD_FIELD.default_value = 8
MANUALFUNCTIONQUESTCMD_CMD_FIELD.enum_type = XCMD_PB_COMMAND
MANUALFUNCTIONQUESTCMD_CMD_FIELD.type = 14
MANUALFUNCTIONQUESTCMD_CMD_FIELD.cpp_type = 8
MANUALFUNCTIONQUESTCMD_PARAM_FIELD.name = "param"
MANUALFUNCTIONQUESTCMD_PARAM_FIELD.full_name = ".Cmd.ManualFunctionQuestCmd.param"
MANUALFUNCTIONQUESTCMD_PARAM_FIELD.number = 2
MANUALFUNCTIONQUESTCMD_PARAM_FIELD.index = 1
MANUALFUNCTIONQUESTCMD_PARAM_FIELD.label = 1
MANUALFUNCTIONQUESTCMD_PARAM_FIELD.has_default_value = true
MANUALFUNCTIONQUESTCMD_PARAM_FIELD.default_value = 23
MANUALFUNCTIONQUESTCMD_PARAM_FIELD.enum_type = QUESTPARAM
MANUALFUNCTIONQUESTCMD_PARAM_FIELD.type = 14
MANUALFUNCTIONQUESTCMD_PARAM_FIELD.cpp_type = 8
MANUALFUNCTIONQUESTCMD_ITEMS_FIELD.name = "items"
MANUALFUNCTIONQUESTCMD_ITEMS_FIELD.full_name = ".Cmd.ManualFunctionQuestCmd.items"
MANUALFUNCTIONQUESTCMD_ITEMS_FIELD.number = 3
MANUALFUNCTIONQUESTCMD_ITEMS_FIELD.index = 2
MANUALFUNCTIONQUESTCMD_ITEMS_FIELD.label = 3
MANUALFUNCTIONQUESTCMD_ITEMS_FIELD.has_default_value = false
MANUALFUNCTIONQUESTCMD_ITEMS_FIELD.default_value = {}
MANUALFUNCTIONQUESTCMD_ITEMS_FIELD.message_type = QUESTMANUALFUNCTION
MANUALFUNCTIONQUESTCMD_ITEMS_FIELD.type = 11
MANUALFUNCTIONQUESTCMD_ITEMS_FIELD.cpp_type = 10
MANUALFUNCTIONQUESTCMD.name = "ManualFunctionQuestCmd"
MANUALFUNCTIONQUESTCMD.full_name = ".Cmd.ManualFunctionQuestCmd"
MANUALFUNCTIONQUESTCMD.nested_types = {}
MANUALFUNCTIONQUESTCMD.enum_types = {}
MANUALFUNCTIONQUESTCMD.fields = {
  MANUALFUNCTIONQUESTCMD_CMD_FIELD,
  MANUALFUNCTIONQUESTCMD_PARAM_FIELD,
  MANUALFUNCTIONQUESTCMD_ITEMS_FIELD
}
MANUALFUNCTIONQUESTCMD.is_extendable = false
MANUALFUNCTIONQUESTCMD.extensions = {}
...
ManualFunctionQuestCmd = protobuf.Message(MANUALFUNCTIONQUESTCMD)
...
QuestManualFunction = protobuf.Message(QUESTMANUALFUNCTION)
