...
function UIModelUtil:SetRolePartModelTexture(uiTexture, partIndex, id, scale, callback, callbackArg)
  local cell = self:GetUIModelCell(uiTexture)
  if cell then
    return cell:SetRolePartModelTexture(uiTexture, partIndex, id, UIModelCameraTrans.Item, scale, callback, callbackArg)
  end
end
...
function UIModelUtil:SetMonsterModelTexture(uiTexture, monsterid, cameraConfig, setConfigTrans, callBack)
...
function UIModelUtil:SetRoleModelTexture(uiTexture, parts, cameraConfig, scale, isPreviewMount, isStatic, suffixMap, callback, callbackArg)
  local cell = self:GetUIModelCell(uiTexture)
  if cell then
    return cell:SetRoleModelTexture(uiTexture, parts, cameraConfig, scale, isPreviewMount, isStatic, suffixMap, callback, callbackArg)
  end
end
