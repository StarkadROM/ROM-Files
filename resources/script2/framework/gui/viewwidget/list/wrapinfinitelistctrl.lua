...
function WrapInfiniteListCtrl:GetNearestCellToCurrent()
  ...
  local minDistToCurrent, minDistCell, dist = self.cellNum * self.wrap.itemSize, nil, nil
  for _, wrapC in pairs(self.ctls) do
...
function WrapInfiniteListCtrl:GetNearestActiveCellToCurrent()
  ...
  local wrapCUpwards, wrapCDownwards, cUpwards, cDownwards = posFactorWrapCMap[factorUpwards], posFactorWrapCMap[factorDownwards], nil, nil
