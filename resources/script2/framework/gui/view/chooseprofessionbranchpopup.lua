...
function ChooseProfessionBranchPopup:ShowRoleModel(profession, tex)
  ...
  if not profCfg or (sex ~= 1 or not profCfg.MaleBody) and not profCfg.FemaleBody then
  end
  parts[Asset_Role.PartIndex.Body] = Game.Myself.data.userdata:Get(UDEnum.BODY)
