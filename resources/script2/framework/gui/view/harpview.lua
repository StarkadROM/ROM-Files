...
function HarpView:Sweep()
  ...
  if offsetX >= -205 and offsetX <= -175 then
    self:PlaySoundEffect(1)
  elseif offsetX >= -123 and offsetX <= -93 then
    self:PlaySoundEffect(2)
  elseif offsetX >= -60 and offsetX <= -28 then
    self:PlaySoundEffect(3)
  elseif offsetX >= -7 and offsetX <= 23 then
    self:PlaySoundEffect(4)
  elseif offsetX >= 45 and offsetX <= 75 then
    self:PlaySoundEffect(5)
  elseif offsetX >= 96 and offsetX <= 126 then
    self:PlaySoundEffect(6)
  elseif offsetX >= 139 and offsetX <= 169 then
    self:PlaySoundEffect(7)
  end
