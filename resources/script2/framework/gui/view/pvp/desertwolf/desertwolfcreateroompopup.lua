...
function DesertWolfCreateRoomPopup:Init()
  ...
  self:AddClickEvent(self.freeFireHelpGO, function()
    self:OnFreeFireHelpClicked()
  end)
  ...
  self:AddClickEvent(self.helpGO, function()
    self:OnHelpClicked()
  end)
  self:LoadRoomData()
...
function DesertWolfCreateRoomPopup:LoadRoomData()
  ...
  if roomData then
    ...
    self.roomNameLabel.text = roomData.roomname or ""
...
function DesertWolfCreateRoomPopup:OnHelpClicked(go)
  local helpData = Table_Help[PanelConfig.DesertWolfCreateRoomPopup.id]
  if helpData then
    TipsView.Me():ShowGeneralHelp(helpData.Desc)
  end
end
function DesertWolfCreateRoomPopup:OnFreeFireHelpClicked()
