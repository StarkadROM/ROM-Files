...
function PvpMainView:InitShow()
  ...
  local teamPwsFunstateValid = FunctionUnLockFunc.checkFuncStateValid(7)
  self.competiveModeToggle:SetActive(teamPwsFunstateValid)
  local pvp12Open = not GameConfig.SystemForbid.TwelvePvpForbid
  local twelveValid = FunctionUnLockFunc.checkFuncStateValid(123) and not GameConfig.SystemForbid.pvp12
