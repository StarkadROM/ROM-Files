...
function ClassicBattleView:OnDestroy()
  ...
  PictureManager.Instance:UnLoadPVP(TEXTURE[1], self.yoyoTex)
  PictureManager.Instance:UnLoadPVP(TEXTURE[2], self.wolfTex)
  PictureManager.Instance:UnLoadPVP(TEXTURE[3], self.matalTex)
