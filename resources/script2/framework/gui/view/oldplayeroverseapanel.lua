...
function OldPlayerOverSeaPanel:initView()
  ...
  if self.invitation.SpecialAward ~= nil then
    ...
    local spreward = Table_Reward[self.invitation.SpecialAward[10000]]
    if spreward then
  ...
  local spreward = Table_Reward[self.invitation.SpecialAward[10001]]
  if spreward then
...
function OldPlayerOverSeaPanel:addListEventListener()
  ...
  self:AddClickEvent(self.Main_HelpTipBtn, function()
    local helpID = 35087
