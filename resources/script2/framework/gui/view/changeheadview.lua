...
function ChangeHeadView:InitView()
  ...
  self.myselfChatDecorate = self:FindGO("Decorate", myselfChat):GetComponent(UISprite)
  ...
  self.someoneChatDecorate = self:FindGO("Decorate", someoneChat):GetComponent(UISprite)
...
function ChangeHeadView:SetChatFramePreviewPart(id)
  ...
  if not config then
    ...
    self.myselfChatDecorate.spriteName = ""
    self.myselfChatBG.flip = 0
    self.someoneChatBG.spriteName = "chatroom_bg_1"
    self.someoneChatDecorate.spriteName = ""
    ...
    self.someoneChatDecorate.spriteName = config.IconName
  ...
  LuaVector3.Better_Set(pos, self.someoneChatBG.width - 2, 25 - self.someoneChatBG.height, 0)
  self.someoneChatDecorate.transform.localPosition = pos
end
