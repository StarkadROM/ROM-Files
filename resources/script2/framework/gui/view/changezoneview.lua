...
function ChangeZoneView:ClickChangeBtn()
  ...
  if value == self.currentZone.text and (not self.languageZoneCell or not self.languageZoneCell.value or self.languageZoneCell.value == self.curZoneInfo.name) then
