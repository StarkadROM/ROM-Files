...
function NewPeddlerShop:AddEvts()
  self:AddClickEvent(self.m_uiImgBtnQuestion, function(go)
...
function NewPeddlerShop:OnClickQuestion()
  local helpData = Table_Help[35247]
...
function NewPeddlerShop:CreateShowShopList(repos)
  ...
  self.m_uiScrollView.enabled = #cells > 3
