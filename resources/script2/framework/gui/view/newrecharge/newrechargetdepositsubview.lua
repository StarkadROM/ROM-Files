...
function NewRechargeTDepositSubView:FindObjs()
  ...
  self.cellListCtrl = UIGridListCtrl.new(cellContainer, NewRechargeTDepositGoodsCell, "NewRechargeCommonGoodsCellType1")
...
function NewRechargeTDepositSubView:LoadView()
