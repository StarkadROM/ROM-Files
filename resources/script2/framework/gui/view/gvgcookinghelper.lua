...
function GVGCookingHelper:getCurTotalValue()
  ...
  if not maxstar or not GameConfig.GvgRimConfig.star_point[maxstar] then
  end
  return (self:getTotalValue())
end
function GVGCookingHelper:getTotalValue()
  return GameConfig.GvgRimConfig.IngredPoint + GameConfig.GvgRimConfig.HeatPoint + GameConfig.GvgRimConfig.SeasoningPoint
end
