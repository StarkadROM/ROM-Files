...
function SignIn21View:OnClickGotoBtn(cellData)
  ...
  if guideId ~= nil and guideId > 0 then
...
function SignIn21View:UpdateTitle()
  ...
  local rewardCount, icon = nextLvRewardItemIds and #nextLvRewardItemIds or 0, nil
...
function SignIn21View:UpdateList(day)
  ...
  self.unlockMenuTitle:SetActive(#unlockMenuData > 0)
