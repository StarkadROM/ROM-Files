...
function LotteryDollView:AddEvts()
  ...
  self:AddClickEvent(self.detailHelpBtnGO, function()
    self:OnHelpClicked()
  end)
end
...
function LotteryDollView:OnHelpClicked()
  local Desc = Table_Help[35040] and Table_Help[35040].Desc or "Table_Help[35040]"
