...
function ActivityDungeonInfo:InitUI()
  ...
  if raidType and raidType == "Einherjar" then
    ...
    self.bottip.text = Table_Help[helpid] and Table_Help[helpid].Desc or "..."
    ...
    self.toptip.text = Table_Help[toptip_helpid[raidType]] and Table_Help[toptip_helpid[raidType]].Desc or ""
    self.bottip.text = Table_Help[bottip_helpid[raidType]] and Table_Help[bottip_helpid[raidType]].Desc or ""
