...
function MainViewRoguelikePage:UpdateLabels(raidData)
  ...
  self:TryUpdateTime()
  self.curLevelLabel.text = raidData.grade
  self.coinLabel.text = raidData.coinCount
  local layerConfig = Table_RoguelikeLayer[raidData.grade]
  self.keysLabel.text = string.format("%s/%s", raidData.keyCount, layerConfig and layerConfig.NeedKeyNum or 0)
  self.deathLabel.text = string.format("%s/%s", raidData.reliveCount or 0, GameConfig.Roguelike.ReliveTimes)
