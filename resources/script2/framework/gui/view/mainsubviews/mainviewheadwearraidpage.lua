...
function MainViewHeadwearRaidPage:AddViewEvents()
  self:AddListenEvt(ServiceEvent.NUserHeadwearNpcUserCmd, self.RecvHeadwearNpcUserCmd)
  self:AddListenEvt(ServiceEvent.NUserHeadwearRoundUserCmd, self.RecvHeadwearRoundUserCmd)
  self:AddListenEvt(ServiceEvent.NUserHeadwearTowerUserCmd, self.RecvHeadwearTowerUserCmd)
...
function MainViewHeadwearRaidPage:RecvHeadwearNpcUserCmd(data)
...
function MainViewHeadwearRaidPage:RefreshAll()
  self:RefreshRoundInfo()
  self:RefreshBaseHP()
  self:RefreshTimeInfo()
  self:RefreshSkills()
...
function MainViewHeadwearRaidPage:RecvHeadwearTowerUserCmd()
  self:RefreshTowers()
end
function MainViewHeadwearRaidPage:RecvPlayerMapChange(note)
...
function MainViewHeadwearRaidPage:RefreshTowers()
...
function MainViewHeadwearRaidPage:SetTowerUpdateTick()
  self.updatetowerTick = tickInstance:CreateTick(0, 300, self.UpdateTowers, self, updatetowerTid)
end
function MainViewHeadwearRaidPage:UpdateTowers()
  HeadwearRaidProxy.Instance:UpdateTowers()
end
function MainViewHeadwearRaidPage:RefreshRoundInfo()
...
function MainViewHeadwearRaidPage:UpdateCountdown()
...
function MainViewHeadwearRaidPage:RefreshBaseHP()
  self.hpLabel.text = proxyInstance.hp_pct .. "%"
  self.hpSlider.value = proxyInstance.hp_pct / 100
end
function MainViewHeadwearRaidPage:RefreshSkills()
  local skilldatas = {}
  for i = 1, #proxyInstance.skills do
...
function MainViewHeadwearRaidPage:RefreshCrystals()
  local crs = {
    self.cr1s,
    self.cr2s,
    self.cr3s
