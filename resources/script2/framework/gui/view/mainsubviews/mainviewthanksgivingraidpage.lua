...
function MainViewThanksgivingRaidPage:UpdateEstrade(estradeDefCount)
  local countText = estradeDefCount and estradeDefCount >= 0 and string.format(ZhString.Thanksgiving_RestEstradeCountFormat, GameConfig.ThanksGiving.show_mvp_mini - estradeDefCount) or ZhString.Thanksgiving_TargetNotAppeared
...
function MainViewThanksgivingRaidPage:UpdateMVP(mvpDefCount)
  local maxMvpCount = 1
  local countText = mvpDefCount and mvpDefCount >= 0 and (mvpDefCount == maxMvpCount and ZhString.Thanksgiving_MVPDefeated or string.format(ZhString.Thanksgiving_MVPCountFormat, maxMvpCount - mvpDefCount, maxMvpCount)) or ZhString.Thanksgiving_TargetNotAppeared
