...
function MainViewSkillPage:callUseReturnPlayerSkill()
  local id = GameConfig.Return.Common.SkillID or 1558001
  if id ~= 0 then
...
function MainViewSkillPage:RefreshReturnSkillBtn()
  ...
  local id = GameConfig.Return.Common.SkillID or 150020
  local skillValid = SkillProxy.Instance:SkillCanBeUsedByID(id)
  if skillValid then
