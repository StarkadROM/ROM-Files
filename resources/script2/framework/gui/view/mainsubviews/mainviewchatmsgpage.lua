...
function MainViewChatMsgPage:StartStoryAudio()
  ...
  self.textContainer.gameObject:SetActive(voiceTxt and #voiceTxt > 0 or false)
...
function MainViewChatMsgPage:RefreshVoiceArrow()
  if self.teamSpeech.gameObject.activeSelf and not self.guildSpeech.gameObject.activeSelf or not self.teamSpeech.gameObject.activeSelf and self.guildSpeech.gameObject.activeSelf then
