...
function MainViewInfoPage:ResetBuffData()
  ...
  TableUtility.ArrayShallowCopy(self.buffListDatas, FunctionBuff.Me():GetMyBuff(true))
  TableUtility.ArrayShallowCopy(self.debuffListDatas, FunctionBuff.Me():GetMyBuff(false))
