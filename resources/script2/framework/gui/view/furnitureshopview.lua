...
function FurnitureShopView:AddEvts()
  ...
  self:AddClickEvent(self:FindGO("BtnHelp", self.objUpBoard), function()
    self:ClickHelp()
  end)
...
function FurnitureShopView:ClickHelp()
  local helpData = Table_Help[PanelConfig.FurnitureShopView.id]
