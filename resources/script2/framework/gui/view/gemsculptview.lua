...
function GemSculptView:InitLeft()
  ...
  GemProxy.TryInitFilterPopOfView(self, "SkillClassFilterPop", updateList, GemSkillQualityFilter, GemSkillQualityFilterData)
  GemProxy.TryInitFilterPopOfView(self, "SkillProfessionFilterPop", updateList, GemSkillProfessionFilter, GemSkillProfessionFilterData)
...
function GemSculptView:OpenHelpView()
  local data = Table_Help[GemFunctionHelpId[GemFunctionState.Sculpt]]
