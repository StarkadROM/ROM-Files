...
if not GameConfig.Artifact or not GameConfig.Artifact.ModelLoadPos then
  local _ModelLoadPos = {
    -22,
    13,
    36
...
function ArtifactMakeView:ClickHelp()
  local helpData = Table_Help[PanelConfig.ArtifactMakeView.id]
