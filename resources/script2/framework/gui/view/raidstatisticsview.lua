...
function RaidStatisticsView:FindObj()
  ...
  self.raidInfoTog = self:FindGO("RaidInfoTog", toggleroot):GetComponent(UIToggle)
  ...
  self.raidInfoTogLab = self.raidInfoTog.gameObject:GetComponent(UILabel)
...
function RaidStatisticsView:AddEvts()
  ...
  self:AddToggleChange(self.raidInfoTog, self.raidInfoTogLab, _ColorBlue, _ColorTitleGray, self.OnClickRaidInfoTog)
...
function RaidStatisticsView:OnClickRaidInfoTog()
...
function RaidStatisticsView:InitCombatInfo()
  ...
  self:InitFilter(self.compareFilterL, pulicConfig.LeftFilter, self.filterDataL, StatisticFilterConfig)
  self:InitFilter(self.recordFilterL, recordFilter, self.recordDataL)
  self:InitFilter(self.compareFilterR, pulicConfig.RightFilter, self.filterDataR, StatisticFilterConfig)
