...
function RoguelikeResultView:OnEnter()
  ...
  if rData.grade > GameConfig.Roguelike.ScoreLayer then
  else
  end
  self.title.text = string.format(ZhString.Roguelike_ResultTitleFormat, rData.grade + (rData.isAllPassed and 0 or -1)) or ""
