...
function RecommendRewardView:InitData()
  ...
  if not self.giftStaticId or not self.giftStaticData or not self.rewards or not next(self.rewards) then
...
function RecommendRewardView:ShowGiftTip(sId, stick, ignoreBound)
  ...
  self:ShowItemTip(tipData, stick, isGoRight > 0 and NGUIUtil.AnchorSide.Left or NGUIUtil.AnchorSide.Right, tipOffset)
end
