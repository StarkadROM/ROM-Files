...
function GVGRankPopUp_Gvg:UpdateCurrentSeason()
  ...
  if nil ~= seasonStatusCfg then
    ...
    self.seasonStatusHelpBtn:SetActive(nil ~= seasonStatusCfg.HelpID)
...
function GVGRankPopUp_Gvg:_UpdateCurrentSeason()
  ...
  self.fixedLabRoot:SetActive(#data > 0)
...
function GVGRankPopUp_Gvg:AddUIEvts()
  ...
  self:AddClickEvent(self.seasonStatusHelpBtn, function()
    TipsView.Me():ShowGeneralHelpByHelpId(_SeasonStatusConfig[self.seasonStatus].HelpID)
  end)
end
