...
MagicBoxPanel.TabPage = {MagicBoxExtractionPage = 1, MagicBoxIllustrationPage = 2}
...
function MagicBoxPanel:InitShow()
  if self.isPreview then
    ...
    self.applyView = self:AddSubView("MagicBoxExtractionPage", MagicBoxExtractionPage)
...
function MagicBoxPanel:OnEnter()
  self:TabChangeHandler(MagicBoxPanel.TabPage.MagicBoxExtractionPage)
