...
function UIEmojiView:SelectTab(index)
  ...
  for i = 1, #self.tabIconSps do
    ...
    if i ~= index or not LuaGeometry.GetTempVector4(0.8509803921568627, 1, 0.9882352941176471, 1) then
    end
    self.tabIconSps[i].gradientTop = LuaGeometry.GetTempVector4(0.7215686274509804, 0.7411764705882353, 0.8627450980392157, 1)
    if i ~= index or not LuaGeometry.GetTempColor() then
    end
    self.tabIconSps[i].gradientBottom = LuaGeometry.GetTempVector4(0.7215686274509804, 0.7411764705882353, 0.8627450980392157, 1)
  end
