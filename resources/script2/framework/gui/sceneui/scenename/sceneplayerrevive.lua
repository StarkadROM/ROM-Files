...
function ScenePlayerRevive._ReviveBySkill(playerid, reviveItem)
  ...
  if (_MapManager:IsPveMode_Thanatos() or _MapManager:IsPVEMode_ComodoRaid() or _MapManager:IsPVEMode_MultiBossRaid()) and not GroupRaidProxy.Instance:CheckCanRevive() then
    MsgManager.ShowMsgByID(25966)
    return
  end
