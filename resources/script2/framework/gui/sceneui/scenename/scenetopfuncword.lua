...
function SceneTopFuncWord:InitCellGO()
  ...
  self.leftlabel = Game.GameObjectUtil:DeepFind(self.gameObject, "LeftLabel"):GetComponent(UILabel)
  self.leftlabelOriginalDepth = self.leftlabel.depth
  self.rightlabel = Game.GameObjectUtil:DeepFind(self.gameObject, "RightLabel"):GetComponent(UILabel)
  self.rightlabelOriginalDepth = self.rightlabel.depth
  self.symbol = Game.GameObjectUtil:DeepFind(self.gameObject, "Symbol"):GetComponent(UISprite)
  self.symbolOriginalDepth = self.symbol.depth
  self.bg = Game.GameObjectUtil:DeepFind(self.gameObject, "Bg1"):GetComponent(UISprite)
