    ...
    if productID then
      ...
      if roleID then
        ...
        if serverID then
          ...
          condition = BranchMgr.IsChina() and runtimePlatform == RuntimePlatform.Android and not BackwardCompatibilityUtil.CompatibilityMode(BackwardCompatibilityUtil.V13)
          if condition then
            TableUtility.TableClear(gReusableTable)
