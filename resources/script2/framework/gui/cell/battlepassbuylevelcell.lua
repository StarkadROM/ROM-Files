...
function BattlePassBuyLevelCell:FindObjs()
  ...
  self:FindComponent("title", UILabel).text = ZhString.BattlePassBuyLevelCell_title
  self:FindComponent("CountTitle", UILabel).text = ZhString.BattlePassBuyLevelCell_CountTitle
