...
function WarbandRewardRankCell:SetData(data)
  ...
  if nil ~= data.endRank or not string.format(ZhString.Warband_RewardIndex1, data.beginRank) then
  end
  self.indexLab.text = string.format(ZhString.Warband_RewardIndex2, data.beginRank, data.endRank)
