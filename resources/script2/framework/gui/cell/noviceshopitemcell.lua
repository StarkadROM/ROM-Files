...
local depositSprite = "activity_novice_bg_02"
local shopSprite = "activity_novice_bg_01"
...
function NoviceShopItemCell:SetData(data)
  if data then
    ...
    if data.GoodsType == NoviceShopProxy.GoodsTypeEnum.Shop then
      ...
      self.shopData = HappyShopProxy.Instance:GetShopItemDataByTypeId(self.data.goodsID)
      ...
      self.priceSprite.spriteName = shopSprite
    else
      ...
      self.priceSprite.spriteName = depositSprite
