...
function WishingCardCell:SetPage(type, data)
  ...
  elseif type == 3 then
    ...
    if data.likenum == 0 or not LuaGeometry.GetTempVector4(0.8901960784313725, 0.4, 0.4, 1) then
    end
    self.likeCount.color = LuaGeometry.GetTempVector4(0.43529411764705883, 0.43529411764705883, 0.43529411764705883, 1)
  ...
  if type == 1 then
    ...
    self:AddClickEvent(self.wishBtn, function()
      MsgManager.ConfirmMsgByID(42116, function()
        ...
        local result = Game.PlotStoryManager:Start_SEQ_PQTLP({40011}, function()
