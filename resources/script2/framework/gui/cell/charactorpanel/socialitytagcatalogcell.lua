...
function SocialityTagCatalogCell:SetChoose(bool)
  ...
  if not bool or not LuaGeometry.GetTempVector4(0.11764705882352941, 0.4392156862745098, 0.7137254901960784, 1) then
  end
  self.label.color = LuaGeometry.GetTempVector4(0.3803921568627451, 0.3803921568627451, 0.3803921568627451, 1)
end
