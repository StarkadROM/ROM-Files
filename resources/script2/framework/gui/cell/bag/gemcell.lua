...
function GemCell:UpdateGemLevel()
  ...
  local isActive = lv ~= nil and type(lv) == "number" and lv >= 1
...
function GemCell:UpdateFavoriteTip()
  ...
  self.favoriteTip:SetActive(self.isShowFavoriteTip and not self:CheckDataIsNilOrEmpty() and GemProxy.CheckIsFavorite(self.data) or false)
end
