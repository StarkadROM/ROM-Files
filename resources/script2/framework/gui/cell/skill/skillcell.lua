...
function SkillCell:UpdateSkillNameBg(skillData, startIndex)
  ...
  if not GameConfig.SkillType[skillData.SkillType].isPassive then
...
function SkillCell:RegisterGuide()
  ...
  local guideId = skillGuideID[skillID]
  if guideId then
    self:AddOrRemoveGuideId(self.skillIcon.gameObject, guideId)
  end
end
