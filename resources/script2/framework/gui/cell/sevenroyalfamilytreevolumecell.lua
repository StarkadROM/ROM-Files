...
function SevenRoyalFamilyTreeVolumeCell:UpdateChoose()
  ...
  if not isChoose or not LuaGeometry.GetTempColor(0.9372549019607843, 0.8862745098039215, 0.7764705882352941) then
  end
  self.emblemSp.color = LuaGeometry.GetTempColor(0.3843137254901961, 0.40784313725490196, 0.5058823529411764)
end
