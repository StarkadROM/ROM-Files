...
local delimiter, tempTable, arrayPushBack = "＋", {}, nil
...
function PersonalArtifactProxy:InitStaticFormulaItemIds()
  self.formulaId = {}
  local cfg, t, element = GameConfig.PersonalArtifactFilter, nil, nil
  for i = 1, #cfg do
    element = {
      class = cfg[i].name
    }
...
function PersonalArtifactProxy:GetStaticAttrDataByIdAndValue(id, value)
  ...
  local attrBoundMap, sId = self.fragmentAttrBoundsMap[id], nil
