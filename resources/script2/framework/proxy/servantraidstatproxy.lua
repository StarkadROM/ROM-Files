...
function ServantRaidStatProxy:GenerateMailContent()
  if self.mail then
    ...
    if myServantid > 0 and Table_Npc and Table_Npc[myServantid] and GameConfig.ServantRaidStat and GameConfig.ServantRaidStat.GenderTrueIntent then
    ...
    if not (indent <= #config.content) or not indent then
      indent = 1
    end
