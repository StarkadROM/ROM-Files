...
local staticDataSortFunc = function(l, r)
  ...
  if ins.showingActId then
    local l1, r1 = ins:CheckDesireComplete(ins.showingActId, r.id) and 1 or ins:CheckDesireComplete(ins.showingActId, l.id) and 1 or 0, 0
    if l1 ~= r1 then
      return l1 > r1
    end
    local l2, r2 = ins:CheckDesireReceived(ins.showingActId, r.id) and 1 or ins:CheckDesireReceived(ins.showingActId, l.id) and 1 or 0, 0
    if l2 ~= r2 then
      return l2 < r2
    end
  end
