...
function ServiceQuestAutoProxy:CallQuestStepUpdate(id, step, data)
  if not NetConfig.PBC then
    ...
    if data ~= nil and data.config.allrewardid ~= nil then
      ...
      if msg.data.config.allrewardid == nil then
        msg.data.config.allrewardid = {}
      end
    ...
    if data ~= nil and data.config.allrewardid ~= nil then
      ...
      if msgParam.data.config.allrewardid == nil then
        msgParam.data.config.allrewardid = {}
      end
      for i = 1, #data.config.allrewardid do
        table.insert(msgParam.data.config.allrewardid, data.config.allrewardid[i])
      end
    end
    if data ~= nil and data.config.PreQuest ~= nil then
      if msgParam.data.config == nil then
...
function ServiceQuestAutoProxy:CallCloseUICmd(questid)
  if not NetConfig.PBC then
...
function ServiceQuestAutoProxy:CallLeaveVisitNpcQuestCmd()
  if not NetConfig.PBC then
