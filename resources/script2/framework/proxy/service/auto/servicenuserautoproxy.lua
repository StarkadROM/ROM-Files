...
function ServiceNUserAutoProxy:CallBattleTimelenUserCmd(timelen, totaltime, musictime, tutortime, estatus, powertime, playtime, usedplaytime)
  if not NetConfig.PBC then
...
function ServiceNUserAutoProxy:CallHeadwearRoundUserCmd(round, blood, skiptime, furytime, crystals, skills)
  if not NetConfig.PBC then
...
function ServiceNUserAutoProxy:CallExtractionRefreshUserCmd(gridid, use_gold, data)
  if not NetConfig.PBC then
...
function ServiceNUserAutoProxy:CallKickOffPassengerUserCmd(kick_charid, all, need_punish)
  if not NetConfig.PBC then
...
function ServiceNUserAutoProxy:CallNoviceTargetRewardUserCmd(id)
  if not NetConfig.PBC then
