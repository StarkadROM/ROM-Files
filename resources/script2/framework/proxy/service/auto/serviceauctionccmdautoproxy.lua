...
function ServiceAuctionCCmdAutoProxy:CallUpdateAuctionInfoCCmd(iteminfo, batchid)
  if not NetConfig.PBC then
    ...
    if iteminfo ~= nil and iteminfo.itemdata.previewenchant.attrs ~= nil then
      ...
      if msg.iteminfo.itemdata.previewenchant.attrs == nil then
        msg.iteminfo.itemdata.previewenchant.attrs = {}
      end
    ...
    if iteminfo ~= nil and iteminfo.itemdata.previewenchant.extras ~= nil then
      ...
      if msg.iteminfo.itemdata.previewenchant.extras == nil then
        msg.iteminfo.itemdata.previewenchant.extras = {}
      end
    ...
    if iteminfo ~= nil and iteminfo.itemdata.previewenchant.patch ~= nil then
      ...
      if msg.iteminfo.itemdata.previewenchant.patch == nil then
        msg.iteminfo.itemdata.previewenchant.patch = {}
      end
    ...
    if iteminfo.itemdata.previewenchant ~= nil and iteminfo.itemdata.previewenchant.type ~= nil then
      ...
      msgParam.iteminfo.itemdata.previewenchant.type = iteminfo.itemdata.previewenchant.type
    end
    if iteminfo ~= nil and iteminfo.itemdata.previewenchant.attrs ~= nil then
      if msgParam.iteminfo.itemdata.previewenchant == nil then
        msgParam.iteminfo.itemdata.previewenchant = {}
      end
      if msgParam.iteminfo.itemdata.previewenchant.attrs == nil then
        msgParam.iteminfo.itemdata.previewenchant.attrs = {}
      end
      for i = 1, #iteminfo.itemdata.previewenchant.attrs do
        table.insert(msgParam.iteminfo.itemdata.previewenchant.attrs, iteminfo.itemdata.previewenchant.attrs[i])
      end
    end
    if iteminfo ~= nil and iteminfo.itemdata.previewenchant.extras ~= nil then
      if msgParam.iteminfo.itemdata.previewenchant == nil then
      ...
      if msgParam.iteminfo.itemdata.previewenchant.extras == nil then
        msgParam.iteminfo.itemdata.previewenchant.extras = {}
      end
      for i = 1, #iteminfo.itemdata.previewenchant.extras do
        table.insert(msgParam.iteminfo.itemdata.previewenchant.extras, iteminfo.itemdata.previewenchant.extras[i])
      end
    end
    if iteminfo ~= nil and iteminfo.itemdata.previewenchant.patch ~= nil then
      if msgParam.iteminfo.itemdata.previewenchant == nil then
      ...
      if msgParam.iteminfo.itemdata.previewenchant.patch == nil then
        msgParam.iteminfo.itemdata.previewenchant.patch = {}
      end
      for i = 1, #iteminfo.itemdata.previewenchant.patch do
        table.insert(msgParam.iteminfo.itemdata.previewenchant.patch, iteminfo.itemdata.previewenchant.patch[i])
      end
    end
    if iteminfo.itemdata.refine ~= nil and iteminfo.itemdata.refine.lastfail ~= nil then
      if msgParam.iteminfo.itemdata == nil then
