...
function ServiceScenePetAutoProxy:CallEquipUpdatePetCmd(petid, update, del)
  if not NetConfig.PBC then
    ...
    if update ~= nil and update.previewenchant.attrs ~= nil then
      ...
      if msg.update.previewenchant.attrs == nil then
        msg.update.previewenchant.attrs = {}
      end
    ...
    if update ~= nil and update.previewenchant.extras ~= nil then
      ...
      if msg.update.previewenchant.extras == nil then
        msg.update.previewenchant.extras = {}
      end
    ...
    if update ~= nil and update.previewenchant.patch ~= nil then
      ...
      if msg.update.previewenchant.patch == nil then
        msg.update.previewenchant.patch = {}
      end
    ...
    if update.previewenchant ~= nil and update.previewenchant.type ~= nil then
      ...
      msgParam.update.previewenchant.type = update.previewenchant.type
    end
    if update ~= nil and update.previewenchant.attrs ~= nil then
      if msgParam.update.previewenchant == nil then
        msgParam.update.previewenchant = {}
      end
      if msgParam.update.previewenchant.attrs == nil then
        msgParam.update.previewenchant.attrs = {}
      end
      for i = 1, #update.previewenchant.attrs do
        table.insert(msgParam.update.previewenchant.attrs, update.previewenchant.attrs[i])
      end
    end
    if update ~= nil and update.previewenchant.extras ~= nil then
      if msgParam.update.previewenchant == nil then
      ...
      if msgParam.update.previewenchant.extras == nil then
        msgParam.update.previewenchant.extras = {}
      end
      for i = 1, #update.previewenchant.extras do
        table.insert(msgParam.update.previewenchant.extras, update.previewenchant.extras[i])
      end
    end
    if update ~= nil and update.previewenchant.patch ~= nil then
      if msgParam.update.previewenchant == nil then
      ...
      if msgParam.update.previewenchant.patch == nil then
        msgParam.update.previewenchant.patch = {}
      end
      for i = 1, #update.previewenchant.patch do
        table.insert(msgParam.update.previewenchant.patch, update.previewenchant.patch[i])
      end
    end
    if update.refine ~= nil and update.refine.lastfail ~= nil then
      if msgParam.update == nil then
