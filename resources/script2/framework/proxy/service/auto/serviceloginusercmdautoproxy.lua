...
function ServiceLoginUserCmdAutoProxy:CallReqLoginUserCmd(accid, sha1, zoneid, timestamp, version, domain, ip, device, phone, safe_device, language, site, authorize, serverid, deviceid, clientversion, langzone, fingerprint)
  if not NetConfig.PBC then
