...
function ServiceMatchCCmdAutoProxy:CallSyncMatchInfoCCmd(etype, ismatch, coldtime)
  if not NetConfig.PBC then
...
function ServiceMatchCCmdAutoProxy:CallQueryTwelveSeasonInfoMatchCCmd(etype, season, season_begin, season_end, season_breakbegin, season_breakend, warband_createbegin, warband_createend, warband_signupbegin, season_initfighttime, season_nextfighttime, season_matchtime, season_fighttime)
  if not NetConfig.PBC then
