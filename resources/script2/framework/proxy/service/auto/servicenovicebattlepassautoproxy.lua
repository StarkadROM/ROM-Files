...
function ServiceNoviceBattlePassAutoProxy:CallNoviceBPTargetRewardCmd(is_all, lv, is_pro)
  if not NetConfig.PBC then
...
function ServiceNoviceBattlePassAutoProxy:CallReturnBPTargetRewardCmd(is_all, lv, is_pro)
  if not NetConfig.PBC then
