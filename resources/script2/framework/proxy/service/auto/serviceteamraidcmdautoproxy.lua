...
function ServiceTeamRaidCmdAutoProxy:CallTeamRaidEnterCmd(raid_type, userid, zoneid, time, sign, difficulty)
  if not NetConfig.PBC then
...
function ServiceTeamRaidCmdAutoProxy:CallGuildTeamRaidCreateCmd()
  if not NetConfig.PBC then
