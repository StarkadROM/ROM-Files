...
function ServiceHomeCmdAutoProxy:CallFurnitureOperHomeCmd(oper, guid, value, source, data, values)
  if not NetConfig.PBC then
...
function ServiceHomeCmdAutoProxy:CallQueryHouseDataHomeCmd(house, garden, furnitures, gfurnitures)
  if not NetConfig.PBC then
    ...
    if gfurnitures ~= nil then
      if msg == nil then
        msg = {}
      end
      if msg.gfurnitures == nil then
        msg.gfurnitures = {}
      end
      for i = 1, #gfurnitures do
        table.insert(msg.gfurnitures, gfurnitures[i])
      end
    end
    self:SendProto(msg)
  else
    ...
    if gfurnitures ~= nil then
      ...
      if msgParam.gfurnitures == nil then
        msgParam.gfurnitures = {}
      end
      for i = 1, #gfurnitures do
        table.insert(msgParam.gfurnitures, gfurnitures[i])
      end
    end
    self:SendProto2(msgId, msgParam)
  end
