...
function ServiceChatCmdAutoProxy:CallQueryItemData(guid, data)
  if not NetConfig.PBC then
    ...
    if data ~= nil and data.previewenchant.attrs ~= nil then
      ...
      if msg.data.previewenchant.attrs == nil then
        msg.data.previewenchant.attrs = {}
      end
    ...
    if data ~= nil and data.previewenchant.extras ~= nil then
      ...
      if msg.data.previewenchant.extras == nil then
        msg.data.previewenchant.extras = {}
      end
    ...
    if data ~= nil and data.previewenchant.patch ~= nil then
      ...
      if msg.data.previewenchant.patch == nil then
        msg.data.previewenchant.patch = {}
      end
    ...
    if data.previewenchant ~= nil and data.previewenchant.type ~= nil then
      ...
      msgParam.data.previewenchant.type = data.previewenchant.type
    end
    if data ~= nil and data.previewenchant.attrs ~= nil then
      if msgParam.data.previewenchant == nil then
        msgParam.data.previewenchant = {}
      end
      if msgParam.data.previewenchant.attrs == nil then
        msgParam.data.previewenchant.attrs = {}
      end
      for i = 1, #data.previewenchant.attrs do
        table.insert(msgParam.data.previewenchant.attrs, data.previewenchant.attrs[i])
      end
    end
    if data ~= nil and data.previewenchant.extras ~= nil then
      if msgParam.data.previewenchant == nil then
      ...
      if msgParam.data.previewenchant.extras == nil then
        msgParam.data.previewenchant.extras = {}
      end
      for i = 1, #data.previewenchant.extras do
        table.insert(msgParam.data.previewenchant.extras, data.previewenchant.extras[i])
      end
    end
    if data ~= nil and data.previewenchant.patch ~= nil then
      if msgParam.data.previewenchant == nil then
      ...
      if msgParam.data.previewenchant.patch == nil then
        msgParam.data.previewenchant.patch = {}
      end
      for i = 1, #data.previewenchant.patch do
        table.insert(msgParam.data.previewenchant.patch, data.previewenchant.patch[i])
      end
    end
    if data.refine ~= nil and data.refine.lastfail ~= nil then
      if msgParam.data == nil then
...
function ServiceChatCmdAutoProxy:CallChatCmd(channel, str, desID, voice, voicetime, msgid, msgover, photo, expression, bshieldword, items)
  if not NetConfig.PBC then
...
function ServiceChatCmdAutoProxy:CallChatRetCmd(accid, id, targetid, portrait, frame, baselevel, voiceid, voicetime, hair, haircolor, body, appellation, msgid, head, face, mouth, eye, roomid, portrait_frame, serverid, channel, rolejob, gender, blink, str, name, guildname, sysmsgid, photo, expression, redpacketret, isreturnuser, chat_frame, items, share_data)
  if not NetConfig.PBC then
...
function ServiceChatCmdAutoProxy:CallSendRedPacketCmd(content, userIDInfo, userInfo)
  if not NetConfig.PBC then
    ...
    if content ~= nil and content.bOvertime ~= nil then
      if msg == nil then
        msg = {}
      end
      if msg.content == nil then
      ...
      msg.content.bOvertime = content.bOvertime
    end
    ...
    if userInfo ~= nil and userInfo.accID ~= nil then
      if msg == nil then
        msg = {}
      end
      ...
      msg.userInfo.accID = userInfo.accID
    end
    if userInfo ~= nil and userInfo.ID ~= nil then
      ...
      msg.userInfo.ID = userInfo.ID
    end
    if userInfo ~= nil and userInfo.portrait ~= nil then
      if msg == nil then
        msg = {}
      end
      if msg.userInfo == nil then
      ...
      msg.userInfo.portrait = userInfo.portrait
    end
    if userInfo ~= nil and userInfo.frame ~= nil then
      if msg == nil then
        msg = {}
      end
      if msg.userInfo == nil then
      ...
      msg.userInfo.frame = userInfo.frame
    end
    if userInfo ~= nil and userInfo.baseLevel ~= nil then
      if msg == nil then
        msg = {}
      end
      if msg.userInfo == nil then
      ...
      msg.userInfo.baseLevel = userInfo.baseLevel
    end
    if userInfo ~= nil and userInfo.hair ~= nil then
      if msg == nil then
        msg = {}
      end
      if msg.userInfo == nil then
      ...
      msg.userInfo.hair = userInfo.hair
    end
    if userInfo ~= nil and userInfo.hairColor ~= nil then
      if msg == nil then
        msg = {}
      end
      if msg.userInfo == nil then
      ...
      msg.userInfo.hairColor = userInfo.hairColor
    end
    if userInfo ~= nil and userInfo.body ~= nil then
      if msg == nil then
        msg = {}
      end
      if msg.userInfo == nil then
      ...
      msg.userInfo.body = userInfo.body
    end
    if userInfo ~= nil and userInfo.appellation ~= nil then
      if msg == nil then
        msg = {}
      end
      if msg.userInfo == nil then
      ...
      msg.userInfo.appellation = userInfo.appellation
    end
    if userInfo ~= nil and userInfo.head ~= nil then
      if msg == nil then
        msg = {}
      end
      if msg.userInfo == nil then
      ...
      msg.userInfo.head = userInfo.head
    end
    if userInfo ~= nil and userInfo.face ~= nil then
      if msg == nil then
        msg = {}
      end
      if msg.userInfo == nil then
      ...
      msg.userInfo.face = userInfo.face
    end
    if userInfo ~= nil and userInfo.mouth ~= nil then
      if msg == nil then
        msg = {}
      end
      if msg.userInfo == nil then
      ...
      msg.userInfo.mouth = userInfo.mouth
    end
    if userInfo ~= nil and userInfo.eye ~= nil then
      if msg == nil then
        msg = {}
      end
      if msg.userInfo == nil then
      ...
      msg.userInfo.eye = userInfo.eye
    end
    if userInfo ~= nil and userInfo.roomID ~= nil then
      if msg == nil then
        msg = {}
      end
      if msg.userInfo == nil then
      ...
      msg.userInfo.roomID = userInfo.roomID
    end
    if userInfo ~= nil and userInfo.portrait_frame ~= nil then
      if msg == nil then
        msg = {}
      end
      if msg.userInfo == nil then
      ...
      msg.userInfo.portrait_frame = userInfo.portrait_frame
    end
    if userInfo ~= nil and userInfo.roleJob ~= nil then
      if msg == nil then
        msg = {}
      end
      if msg.userInfo == nil then
      ...
      msg.userInfo.roleJob = userInfo.roleJob
    end
    if userInfo ~= nil and userInfo.gender ~= nil then
      if msg == nil then
        msg = {}
      end
      if msg.userInfo == nil then
      ...
      msg.userInfo.gender = userInfo.gender
    end
    if userInfo ~= nil and userInfo.blink ~= nil then
      if msg == nil then
        msg = {}
      end
      if msg.userInfo == nil then
      ...
      msg.userInfo.blink = userInfo.blink
    end
    if userInfo ~= nil and userInfo.name ~= nil then
      if msg == nil then
        msg = {}
      end
      if msg.userInfo == nil then
      ...
      msg.userInfo.name = userInfo.name
    end
    if userInfo ~= nil and userInfo.guildName ~= nil then
      if msg == nil then
        msg = {}
      end
      if msg.userInfo == nil then
      ...
      msg.userInfo.guildName = userInfo.guildName
    end
    self:SendProto(msg)
  else
    ...
    if content ~= nil and content.bOvertime ~= nil then
      ...
      msgParam.content.bOvertime = content.bOvertime
    end
    if content ~= nil and content.bShieldWord ~= nil then
      if msgParam == nil then
        msgParam = {}
    ...
    if userInfo ~= nil and userInfo.accID ~= nil then
      ...
      if msgParam.userInfo == nil then
        msgParam.userInfo = {}
      end
      msgParam.userInfo.accID = userInfo.accID
    end
    if userInfo ~= nil and userInfo.ID ~= nil then
      if msgParam == nil then
        msgParam = {}
      ...
      msgParam.userInfo.ID = userInfo.ID
    end
    if userInfo ~= nil and userInfo.portrait ~= nil then
      if msgParam == nil then
        msgParam = {}
      ...
      msgParam.userInfo.portrait = userInfo.portrait
    end
    if userInfo ~= nil and userInfo.frame ~= nil then
      if msgParam == nil then
        msgParam = {}
      ...
      msgParam.userInfo.frame = userInfo.frame
    end
    if userInfo ~= nil and userInfo.baseLevel ~= nil then
      if msgParam == nil then
        msgParam = {}
      ...
      msgParam.userInfo.baseLevel = userInfo.baseLevel
    end
    if userInfo ~= nil and userInfo.hair ~= nil then
      if msgParam == nil then
        msgParam = {}
      ...
      msgParam.userInfo.hair = userInfo.hair
    end
    if userInfo ~= nil and userInfo.hairColor ~= nil then
      if msgParam == nil then
        msgParam = {}
      ...
      msgParam.userInfo.hairColor = userInfo.hairColor
    end
    if userInfo ~= nil and userInfo.body ~= nil then
      if msgParam == nil then
        msgParam = {}
      ...
      msgParam.userInfo.body = userInfo.body
    end
    if userInfo ~= nil and userInfo.appellation ~= nil then
      if msgParam == nil then
        msgParam = {}
      ...
      msgParam.userInfo.appellation = userInfo.appellation
    end
    if userInfo ~= nil and userInfo.head ~= nil then
      if msgParam == nil then
        msgParam = {}
      ...
      msgParam.userInfo.head = userInfo.head
    end
    if userInfo ~= nil and userInfo.face ~= nil then
      if msgParam == nil then
        msgParam = {}
      ...
      msgParam.userInfo.face = userInfo.face
    end
    if userInfo ~= nil and userInfo.mouth ~= nil then
      if msgParam == nil then
        msgParam = {}
      ...
      msgParam.userInfo.mouth = userInfo.mouth
    end
    if userInfo ~= nil and userInfo.eye ~= nil then
      if msgParam == nil then
        msgParam = {}
      ...
      msgParam.userInfo.eye = userInfo.eye
    end
    if userInfo ~= nil and userInfo.roomID ~= nil then
      if msgParam == nil then
        msgParam = {}
      ...
      msgParam.userInfo.roomID = userInfo.roomID
    end
    if userInfo ~= nil and userInfo.portrait_frame ~= nil then
      if msgParam == nil then
        msgParam = {}
      ...
      msgParam.userInfo.portrait_frame = userInfo.portrait_frame
    end
    if userInfo ~= nil and userInfo.roleJob ~= nil then
      if msgParam == nil then
        msgParam = {}
      ...
      msgParam.userInfo.roleJob = userInfo.roleJob
    end
    if userInfo ~= nil and userInfo.gender ~= nil then
      if msgParam == nil then
        msgParam = {}
      ...
      msgParam.userInfo.gender = userInfo.gender
    end
    if userInfo ~= nil and userInfo.blink ~= nil then
      if msgParam == nil then
        msgParam = {}
      ...
      msgParam.userInfo.blink = userInfo.blink
    end
    if userInfo ~= nil and userInfo.name ~= nil then
      if msgParam == nil then
        msgParam = {}
      ...
      msgParam.userInfo.name = userInfo.name
    end
    if userInfo ~= nil and userInfo.guildName ~= nil then
      if msgParam == nil then
        msgParam = {}
      ...
      msgParam.userInfo.guildName = userInfo.guildName
    end
    self:SendProto2(msgId, msgParam)
  end
end
function ServiceChatCmdAutoProxy:CallReceiveRedPacketCmd(strRedPacketID, senderID, userIDInfo, isBeyondReceiveLinit)
  if not NetConfig.PBC then
...
function ServiceChatCmdAutoProxy:CallReceiveRedPacketRet(strRedPacketID, bRedPacketExist, bRedPacketUsable, content, thisReceiveMoney, userIDInfo)
  if not NetConfig.PBC then
