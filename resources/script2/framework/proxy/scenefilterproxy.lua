...
function SceneFilterProxy:SceneFilterCheckWithContents(id, contents, creature)
  if not creature then
    return
  end
  for i = 1, #contents do
    self.handlerMap[contents[i]](self, creature, id, true)
  end
end
function SceneFilterProxy:SceneFilterUnCheckWithContents(id, contents, creature)
  if not creature then
    return
  end
  for i = 1, #contents do
    self.handlerMap[contents[i]](self, creature, id, false)
  end
end
