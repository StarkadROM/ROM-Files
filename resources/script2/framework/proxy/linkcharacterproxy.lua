...
function LinkCharacterProxy:SetCurrentCharacter(charId)
  ...
  if self.curCharCfg then
    local pCfg, rCfg, osCfg = self.curCharCfg.OrthographicSize or self.curCharCfg.CameraPosition or initialCameraPos, self.curCharCfg.CameraRotation or initialCameraRot, initialOrthographicSize
