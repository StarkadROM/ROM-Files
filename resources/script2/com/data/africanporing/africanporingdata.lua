...
function AfricanPoringData:IsActive()
  ...
  if not self.startTime or not self.endTime or serverTime < self.startTime or serverTime > self.endTime then
    return false
  end
  return true
end
...
function AfricanPoringData:SortShopItems()
  ...
  table.sort(self.shopItems, function(a, b)
    ...
    local canBuyA = canBuyNumA == nil or canBuyNumA > 0
    local canBuyB = canBuyNumB == nil or canBuyNumB > 0
