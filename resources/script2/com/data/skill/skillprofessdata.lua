...
function SkillProfessData:AddSkill(serverSkillItem)
  local skillItemData = SkillItemData.new(serverSkillItem.id, serverSkillItem.pos, serverSkillItem.autopos, self.profession, serverSkillItem.sourceid, serverSkillItem.extendpos, serverSkillItem.shortcuts, serverSkillItem.extramaxlv)
