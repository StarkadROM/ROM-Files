...
function TeamData:IsTeamFull()
  local maxmember = TeamProxy.IsRoguelike(self.type) and GameConfig.Team.Roguelike_maxmember or GameConfig.Team.maxmember
...
function TeamData:SetRoleList(result, roles, wanted, Max)
  ...
  if Max > #result and wanted and #wanted > 0 then
    for i = 1, #wanted do
