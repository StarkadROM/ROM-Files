...
function FollowFun.checkRaidCanFollow(beraidcfg)
  ...
  if beraidcfg.Type == 4 then
    if follower.baselv < GameConfig.EndlessTower.limit_user_lv then
      return FollowFun.updateResult(1315, FollowFun.Action.EFOLLOWACTION_NONE)
    end
  elseif beraidcfg.Type == 14 or beraidcfg.Type == 30 or beraidcfg.Type == 43 or beraidcfg.Type == 50 or beraidcfg.Type == 52 then
    return FollowFun.updateResult(27018, FollowFun.Action.EFOLLOWACTION_NONE)
...
function FollowFun.checkFollow()
  ...
  if bemapcfg.CloneMap ~= nil and bemapcfg.CloneMap ~= 0 then
  ...
  if raidcfg ~= nil then
    ...
    if beraidcfg ~= nil then
      ...
      elseif beraidcfg.Type == 43 or beraidcfg.Type == 50 then
        return FollowFun.updateResult(39207, FollowFun.Action.EFOLLOWACTION_NONE)
      end
